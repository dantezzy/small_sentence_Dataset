...
if __name__ == '__main__':
    mvad_train = open("train_split/TrainCorpus.txt","r")
    mvad_test = open("test_split/TestCorpus.txt","r")
    ...
    def stemmed_words(d):
        attribute_names = [token.lower() for token in wordpunct_tokenize(
            re.sub('[%s]' % re.escape(string.punctuation), '', d))]
    ...
    newOpenFile=open("mvad_test.txt","w")
